...
class AttendanceRecordCheckInView(GenericAPIView):
    ...
    Provides an endpoint to add an establishment guard attendance record for performing the check-in.
    ...
    post:
        summary: Add an establishment guard attendance record for check-in.

        responses:
            200:
                description: Check-in successfully performed.
            400:
                description: Bad request. Invalid or missing parameters in the request.
            403:
                description: Forbidden. User does not have the required permissions.
            404:
                description: Not found. No valid establishment guard record found for the user.
    ...
    def post(self, request):
        """
        Method POST: Add Establishment Guard Attendance Record to perform CheckIn

        This method handles the HTTP POST request to create an EstablishmentGuardAttendanceRecord for check-in.
        ...
        # manually add 'address' key data as Attendance Address as that key is defined as mandatory in model
        ...
        if location_create_serializer.is_valid():
            ...
            with transaction.atomic():
                ...
                # DeviceIdSerializer serializer errors
                # Rollback the transaction
                transaction.set_rollback(True)
                return_data = {
                    settings.REST_FRAMEWORK['NON_FIELD_ERRORS_KEY']: [get_global_error_messages('SOMETHING_WENT_WRONG')],
        ...
        # LocationCreateSerializer serializer errors
        return_data = {
...
class AttendanceRecordCheckOutView(GenericAPIView):
    ...
    Provides an endpoint to update the establishment guard attendance record for performing the check-out.
    ...
    patch:
        summary: Update the establishment guard attendance record for check-out.

        responses:
            200:
                description: Check-out successfully performed.
            400:
                description: Bad request. Invalid or missing parameters in the request.
            403:
                description: Forbidden. User does not have the required permissions.
    ...
    def patch(self, request, format=None):
        """
        Method PATCH: Update Establishment Guard Attendance Record to perform CheckOut

        This method handles the HTTP PATCH request to update the establishment guard attendance record for check-out.
                    ...
                    if device_id_create_serializer.is_valid():
                        ...
                        if attendance_record_checkout_serializer.is_valid():
                            ...
                            return_data = {
                                ...
                                'is_checkin' : False,
                                'is_checkout' : True,
                                'sign_in_image' : attendance_record_checkout_serializer.data['sign_in_image'],
                                'sign_out_image' : attendance_record_checkout_serializer.data['sign_out_image'],
                            }
...
class AttendanceCurrentStatus(GenericAPIView):
    ...
    Provides an endpoint to retrieve the current status of the attendance record.
    ...
    get:
        summary: Retrieve the current status of the Attendance record.

        responses:
            200:
                description: Attendance record status successfully retrieved.
            403:
                description: Forbidden. User does not have the required permissions.
            404:
                description: Not found. No valid establishment guard record found for the user.
    ...
    def get(self, request, format=None):
        """
        Method GET: Retrieve the current status of the Attendance record

        This method handles the HTTP GET request to retrieve the current status of the attendance record.
